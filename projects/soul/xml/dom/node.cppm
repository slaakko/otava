...
public:
    ...
    ParentNode* Parent() const noexcept;
    inline Node* Prev() const noexcept { return prev; }
    inline Node* Next() const noexcept { return next; }
    inline Document* OwnerDocument() const noexcept;
    inline void SetOwnerDocument(Document* ownerDocumnent_) noexcept;
...
private:
    ...
    void SetParent(ParentNode* parent_) noexcept;
