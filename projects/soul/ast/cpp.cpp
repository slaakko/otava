...
void ExprListNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("(");
    bool first = true;
    for (const auto& expr : exprs)
...
void ThisNode::Write(util::CodeFormatter& formatter)
{
...
void IdExprNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write(id);
}
...
void IndexExprNode::Write(util::CodeFormatter& formatter)
{
...
void InvokeNode::Write(util::CodeFormatter& formatter)
{
    Child()->Write(formatter);
    formatter.Write("(");
    bool first = true;
...
void MemberAccessNode::Write(util::CodeFormatter& formatter)
{
    Child()->Write(formatter);
    formatter.Write(".");
...
void PtrMemberAccessNode::Write(util::CodeFormatter& formatter)
{
    Child()->Write(formatter);
    formatter.Write("->");
    member->Write(formatter);
...
void PostIncrementNode::Write(util::CodeFormatter& formatter)
{
    Child()->Write(formatter);
    formatter.Write("++");
}
...
void PostDecrementNode::Write(util::CodeFormatter& formatter)
{
    Child()->Write(formatter);
    formatter.Write("--");
}
...
void StaticCastNode::Write(util::CodeFormatter& formatter)
{
...
void DynamicCastNode::Write(util::CodeFormatter& formatter)
{
...
void ReinterpretCastNode::Write(util::CodeFormatter& formatter)
{
...
void ConstCastNode::Write(util::CodeFormatter& formatter)
{
...
void PostCastNode::Write(util::CodeFormatter& formatter)
{
...
void TypeIdExprNode::Write(util::CodeFormatter& formatter)
{
...
void PreIncrementNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("++");
    Child()->Write(formatter);
}
...
void PreDecrementNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("--");
    Child()->Write(formatter);
}
...
void UnaryOpExprNode::Write(util::CodeFormatter& formatter)
{
...
void SizeOfNode::Write(util::CodeFormatter& formatter)
{
...
void CastNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("(");
    type->Write(formatter);
    formatter.Write(")");
...
void BinaryOpExprNode::Write(util::CodeFormatter& formatter)
{
...
void ConditionalNode::Write(util::CodeFormatter& formatter)
{
...
void NewNode::Write(util::CodeFormatter& formatter)
{
    if (global)
    {
        formatter.Write("::");
...
void DeleteNode::Write(util::CodeFormatter& formatter)
{
    if (global)
    {
        formatter.Write("::");
...
void ParenExprNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("(");
    Child()->Write(formatter);
    formatter.Write(")");
...
void LiteralNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write(rep);
}
...
void LabeledStatementNode::Write(util::CodeFormatter& formatter)
{
...
void CaseStatementNode::Write(util::CodeFormatter& formatter)
{
...
void DefaultStatementNode::Write(util::CodeFormatter& formatter)
{
...
void EmptyStatementNode::Write(util::CodeFormatter& formatter)
{
    formatter.WriteLine(";");
}
...
void ExpressionStatementNode::Write(util::CodeFormatter& formatter)
{
    expr->Write(formatter);
    formatter.WriteLine(";");
}
...
void CompoundStatementNode::Write(util::CodeFormatter& formatter)
{
    formatter.WriteLine("{");
    formatter.IncIndent();
    for (const auto& stmt : statements)
...
void IfStatementNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("if (");
...
void SwitchStatementNode::Write(util::CodeFormatter& formatter)
{
...
void WhileStatementNode::Write(util::CodeFormatter& formatter)
{
...
void DoStatementNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("do");
    if (stmt->IsCompoundStatementNode())
    {
...
void ForStatementNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("for (");
    if (init)
    {
...
void BreakStatementNode::Write(util::CodeFormatter& formatter)
{
...
void ContinueStatementNode::Write(util::CodeFormatter& formatter)
{
...
void GotoStatementNode::Write(util::CodeFormatter& formatter)
{
...
void ReturnStatementNode::Write(util::CodeFormatter& formatter)
{
...
void ConditionWithDeclaratorNode::Write(util::CodeFormatter& formatter)
{
    type->Write(formatter);
...
void ForRangeDeclarationNode::Write(util::CodeFormatter& formatter)
{
...
void RangeForStatementNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write("for (");
    declaration->Write(formatter);
    formatter.Write(" : ");
...
void DeclarationStatementNode::Write(util::CodeFormatter& formatter)
{
    declaration->Write(formatter);
    formatter.WriteLine(";");
}
...
void IfdefStatementNode::Write(util::CodeFormatter& formatter)
{
...
void EndIfStatementNode::Write(util::CodeFormatter& formatter)
{
...
void AssignInitNode::Write(util::CodeFormatter& formatter)
{
    if (assignmentExpr)
    {
...
void InitializerNode::Write(util::CodeFormatter& formatter)
{
    if (assignInit)
    {
        formatter.Write(" = ");
...
void InitDeclaratorNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write(declarator);
    if (initializer)
    {
...
void InitDeclaratorListNode::Write(util::CodeFormatter& formatter)
{
    bool first = true;
...
void TypedefNode::Write(util::CodeFormatter& formatter)
{
...
void TypeSpecifierNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write(Name());
}
...
void TypeNameNode::Write(util::CodeFormatter& formatter)
{
...
void TypeNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write(ToString());
}
...
void StorageClassSpecifierNode::Write(util::CodeFormatter& formatter)
{
    formatter.Write(Name());
}
...
void TypeIdNode::Write(util::CodeFormatter& formatter)
{
    bool first = true;
    for (const auto& typeSpecifier : typeSpecifiers)
    {
...
void TypeIdNode::WriteNonPtrType(util::CodeFormatter& formatter)
{
    if (IsPtrType())
    {
        bool first = true;
...
void SimpleDeclarationNode::Write(util::CodeFormatter& formatter)
{
    bool first = true;
...
void NamespaceAliasNode::Write(util::CodeFormatter& formatter)
{
...
void UsingDeclarationNode::Write(util::CodeFormatter& formatter)
{
...
void UsingDirectiveNode::Write(util::CodeFormatter& formatter)
{
