...
void CharSymbol::Print(util::CodeFormatter& formatter)
{
    if (chr == eps)
    {
        formatter.Write("EPS");
...
void Any::Print(util::CodeFormatter& formatter)
{
    formatter.Write(".");
}
...
void Range::Print(util::CodeFormatter& formatter)
{
...
void Class::Print(util::CodeFormatter& formatter)
{
...
void NfaEdge::Print(util::CodeFormatter& formatter)
{
    symbol->Print(formatter);
...
void NfaState::Print(util::CodeFormatter& formatter)
{
...
void Nfa::Print(util::CodeFormatter& formatter)
{
...
void DfaState::Print(LexerContext& context, util::CodeFormatter& formatter)
{
    std::string str = std::to_string(id);
    str.append("[");
    bool first = true;
...
void Dfa::Print(LexerContext& lexerContext, util::CodeFormatter& formatter)
{
