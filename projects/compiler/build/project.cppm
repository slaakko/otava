...
public:
    ...
    std::unique_ptr<otava::symbols::Module> ReleaseModule(int file);
    void MapFiles();
    inline const std::string& RootDir() const { return rootDir; }
    ...
    otava::symbols::SymbolId GetIrId(const std::string& groupFullName, otava::symbols::Cardinality arity) override;
    void SetIrId(const std::string& groupFullName, otava::symbols::Cardinality arity, otava::symbols::SymbolId irId) override;
private:
    ...
    std::map<std::pair<std::string, otava::symbols::Cardinality>, otava::symbols::SymbolId> irIdMap;
};
