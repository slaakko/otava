...
public:
    ...
    AsmDeclarationNode(const soul::ast::Span& span_, int fileIndex_, Node* asm__, Node* asmText_, Node* semicolon_, Node* attributes_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    LinkageSpecificationNode(const soul::ast::Span& span_, int fileIndex_, Node* extrn_, Node* linkage_, Node* declarations_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    NamespaceDefinitionNode(const soul::ast::Span& span_, int fileIndex_, Node* nskw_, Node* nsName_, Node* nsBody_, Node* inln_, Node* attributes_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    ParenthesizedDeclaratorNode(const soul::ast::Span& span_, int fileIndex_, Node* declarator_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    ConditionalExplicitNode(const soul::ast::Span& span_, int fileIndex_, Node* cond_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    ArrayDeclaratorNode(const soul::ast::Span& span_, int fileIndex_, Node* child_, Node* dimension_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    NoexceptSpecifierNode(const soul::ast::Span& span_, int fileIndex_, Node* constantExpr_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
