...
CastExprNode::CastExprNode(const soul::ast::Span& span_, int fileIndex_, Node* typeId_, Node* child_) noexcept :
    UnaryNode(NodeKind::castExprNode, span_, fileIndex_, child_), typeId(typeId_)
{
}

Node* CastExprNode::Clone() const
{
    CastExprNode* clone = new CastExprNode(GetSpan(), FileIndex(), typeId->Clone(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
SizeOfTypeExprNode::SizeOfTypeExprNode(const soul::ast::Span& span_, int fileIndex_, Node* typeId_) noexcept :
    UnaryNode(NodeKind::sizeOfTypeExprNode, span_, fileIndex_, typeId_)
{
}

Node* SizeOfTypeExprNode::Clone() const
{
    SizeOfTypeExprNode* clone = new SizeOfTypeExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
SizeOfPackExprNode::SizeOfPackExprNode(const soul::ast::Span& span_, int fileIndex_, Node* idNode_) noexcept :
    UnaryNode(NodeKind::sizeOfPackExpNode, span_, fileIndex_, idNode_)
{
}

Node* SizeOfPackExprNode::Clone() const
{
    SizeOfPackExprNode* clone = new SizeOfPackExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
AlignOfExprNode::AlignOfExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::alignOfExprNode, span_, fileIndex_, child_)
{
}

Node* AlignOfExprNode::Clone() const
{
    AlignOfExprNode* clone = new AlignOfExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
NoexceptExprNode::NoexceptExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::noexceptExprNode, span_, fileIndex_, child_)
{
}

Node* NoexceptExprNode::Clone() const
{
    NoexceptExprNode* clone = new NoexceptExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
NewExprNode::NewExprNode(const soul::ast::Span& span_, int fileIndex_, Node* placement_, Node* child_, Node* initializer_, Node* colonColonHead_) noexcept :
    UnaryNode(NodeKind::newExprNode, span_, fileIndex_, child_), placement(placement_), initializer(initializer_), colonColonHead(colonColonHead_)
{
}
...
Node* NewExprNode::Clone() const
{
    ...
    NewExprNode* clone = new NewExprNode(GetSpan(), FileIndex(), clonedPlacement, Child()->Clone(), clonedInitializer, clonedColonColonHead);
    clone->SetId(Id());
    return clone;
}
...
ParenNewTypeIdNode::ParenNewTypeIdNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::parenNewTypeIdNode, span_, fileIndex_, child_)
{
}

Node* ParenNewTypeIdNode::Clone() const
{
    ParenNewTypeIdNode* clone = new ParenNewTypeIdNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
ArrayDeletePtrNode::ArrayDeletePtrNode(const soul::ast::Span& span_, int fileIndex_, Node* ptr_, Node* colonColonHead_) noexcept :
    UnaryNode(NodeKind::arrayDeletePtrNode, span_, fileIndex_, ptr_), colonColonHead(colonColonHead_)
{
}
...
Node* ArrayDeletePtrNode::Clone() const
{
    ...
    ArrayDeletePtrNode* clone = new ArrayDeletePtrNode(GetSpan(), FileIndex(), Child()->Clone(), clonedColonColonHead);
    clone->SetId(Id());
    return clone;
}
...
DeletePtrNode::DeletePtrNode(const soul::ast::Span& span_, int fileIndex_, Node* ptr_, Node* colonColonHead_) noexcept :
    UnaryNode(NodeKind::deletePtrNode, span_, fileIndex_, ptr_), colonColonHead(colonColonHead_)
{
}
...
Node* DeletePtrNode::Clone() const
{
    ...
    DeletePtrNode* clone = new DeletePtrNode(GetSpan(), FileIndex(), Child()->Clone(), clonedColonColonHead);
    clone->SetId(Id());
    return clone;
}
...
SubscriptExprNode::SubscriptExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_, Node* index_) noexcept :
    UnaryNode(NodeKind::subscriptExprNode, span_, fileIndex_, child_), index(index_)
{
}

Node* SubscriptExprNode::Clone() const
{
    SubscriptExprNode* clone = new SubscriptExprNode(GetSpan(), FileIndex(), Child()->Clone(), index->Clone());
    clone->SetId(Id());
    return clone;
}
...
PostfixIncExprNode::PostfixIncExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::postfixIncExprNode, span_, fileIndex_, child_)
{
}

Node* PostfixIncExprNode::Clone() const
{
    PostfixIncExprNode* clone = new PostfixIncExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
PostfixDecExprNode::PostfixDecExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::postfixDecExprNode, span_, fileIndex_, child_)
{
}

Node* PostfixDecExprNode::Clone() const
{
    PostfixDecExprNode* clone = new PostfixDecExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
TypeIdExprNode::TypeIdExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::typeIdExprNode, span_, fileIndex_, child_)
{
}

Node* TypeIdExprNode::Clone() const
{
    TypeIdExprNode* clone = new TypeIdExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
...
CppCastExprNode::CppCastExprNode(const soul::ast::Span& span_, int fileIndex_, Node* typeId_, Node* child_, Node* op_) noexcept :
    UnaryNode(NodeKind::cppCastExprNode, span_, fileIndex_, child_), typeId(typeId_), op(op_)
{
}

Node* CppCastExprNode::Clone() const
{
    CppCastExprNode* clone = new CppCastExprNode(GetSpan(), FileIndex(), typeId->Clone(), Child()->Clone(), op->Clone());
    clone->SetId(Id());
    return clone;
}
...
ParenthesizedExprNode::ParenthesizedExprNode(const soul::ast::Span& span_, int fileIndex_, Node* child_) noexcept :
    UnaryNode(NodeKind::parenExprNode, span_, fileIndex_, child_)
{
}

Node* ParenthesizedExprNode::Clone() const
{
    ParenthesizedExprNode* clone = new ParenthesizedExprNode(GetSpan(), FileIndex(), Child()->Clone());
    clone->SetId(Id());
    return clone;
}
