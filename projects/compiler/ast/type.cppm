...
public:
    ...
    DeclTypeSpecifierNode(const soul::ast::Span& span_, int fileIndex_, Node* expr_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
...
public:
    ...
    PlaceholderTypeSpecifierNode(const soul::ast::Span& span_, int fileIndex_, Node* typeConstraint_, bool declType_) noexcept;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    void Write(Writer& writer) override;
    void Read(Reader& reader) override;
    inline Node* TypeConstraint() const { return typeConstraint.get(); }
    inline bool DeclType() const { return declType; }
private:
