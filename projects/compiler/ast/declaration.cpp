...
AsmDeclarationNode::AsmDeclarationNode(const soul::ast::Span& span_, int fileIndex_, Node* asm__, Node* asmText_, Node* semicolon_, Node* attributes_) noexcept :
...
Node* AsmDeclarationNode::Clone() const
{
    ...
    AsmDeclarationNode* clone = new AsmDeclarationNode(GetSpan(), FileIndex(), asm_->Clone(), asmText->Clone(), semicolon->Clone(), clonedAttributes);
    clone->SetId(Id());
    return clone;
}
...
LinkageSpecificationNode::LinkageSpecificationNode(const soul::ast::Span& span_, int fileIndex_, Node* extrn_, Node* linkage_, Node* declarations_) noexcept :
    CompoundNode(NodeKind::linkageSpecificationNode, span_, fileIndex_), extrn(extrn_), linkage(linkage_), declarations(declarations_)
{
}
...
Node* LinkageSpecificationNode::Clone() const
{
    ...
    LinkageSpecificationNode* clone = new LinkageSpecificationNode(GetSpan(), FileIndex(), extrn->Clone(), linkage->Clone(), clonedDeclarations);
    clone->SetId(Id());
    return clone;
}
...
StaticAssertDeclarationNode::StaticAssertDeclarationNode(const soul::ast::Span& span_, int fileIndex_, Node* staticAssert_, Node* constantExpr_, Node* comma_,
    Node* stringLiteral_, Node* semicolon_) noexcept :
    ...
    stringLiteral(stringLiteral_), semicolon(semicolon_)
{
}
...
Node* StaticAssertDeclarationNode::Clone() const
{
    ...
    StaticAssertDeclarationNode* clone = new StaticAssertDeclarationNode(GetSpan(), FileIndex(), staticAssert->Clone(), constantExpr->Clone(), 
        clonedComma, clonedStringLiteral, semicolon->Clone());
    clone->SetId(Id());
    return clone;
}
...
ParenthesizedDeclaratorNode::ParenthesizedDeclaratorNode(const soul::ast::Span& span_, int fileIndex_, Node* declarator_) noexcept :
    CompoundNode(NodeKind::parenthesizedDeclaratorNode, span_, fileIndex_), declarator(declarator_)
{
}

Node* ParenthesizedDeclaratorNode::Clone() const
{
    ParenthesizedDeclaratorNode* clone = new ParenthesizedDeclaratorNode(GetSpan(), FileIndex(), declarator->Clone());
    clone->SetId(Id());
    return clone;
}
...
ConditionalExplicitNode::ConditionalExplicitNode(const soul::ast::Span& span_, int fileIndex_, Node* cond_) noexcept :
    UnaryNode(NodeKind::conditionalExplicitNode, span_, fileIndex_, cond_)
{
}

Node* ConditionalExplicitNode::Clone() const
{
    ConditionalExplicitNode* clone = new ConditionalExplicitNode(GetSpan(), FileIndex(), cond->Clone());
    clone->SetId(Id());
    return clone;
}
...
ArrayDeclaratorNode::ArrayDeclaratorNode(const soul::ast::Span& span_, int fileIndex_, Node* child_, Node* dimension_) noexcept :
    UnaryNode(NodeKind::arrayDeclaratorNode, span_, fileIndex_, child_), dimension(dimension_)
{
}
...
Node* ArrayDeclaratorNode::Clone() const
{
    ...
    ArrayDeclaratorNode* clone = new ArrayDeclaratorNode(GetSpan(), FileIndex(), Child()->Clone(), clonedDimension);
    clone->SetId(Id());
    return clone;
}
...
NoexceptSpecifierNode::NoexceptSpecifierNode(const soul::ast::Span& span_, int fileIndex_, Node* constantExpr_) noexcept :
    CompoundNode(NodeKind::noexceptSpecifierNode, span_, fileIndex_), constantExpr(constantExpr_)
{
}
...
Node* NoexceptSpecifierNode::Clone() const
{
    ...
    NoexceptSpecifierNode* clone = new NoexceptSpecifierNode(GetSpan(), FileIndex(), clonedConstantExpr);
    clone->SetId(Id());
    return clone;
}
...
{
    ThrowSpecifierNode* clone = new ThrowSpecifierNode(GetSpan(), FileIndex());
    clone->SetId(Id());
    return clone;
}
