...
DeductionGuideNode::DeductionGuideNode(const soul::ast::Span& span_, int fileIndex_, Node* templateName_, Node* params_, Node* arrow_, Node* templateId_,
    Node* explicitSpecifier_, Node* semicolon_) noexcept :
...
Node* DeductionGuideNode::Clone() const
{
    ...
    DeductionGuideNode* clone = new DeductionGuideNode(GetSpan(), FileIndex(), templateName->Clone(), params->Clone(), arrow->Clone(), 
        templateId->Clone(), clonedExplicitSpecifier, semicolon->Clone());
    clone->SetId(Id());
    return clone;
}
...
ExplicitSpecializationNode::ExplicitSpecializationNode(const soul::ast::Span& span_, int fileIndex_, Node* tmp_, Node* templateHeadNode_, Node* declaration_) noexcept :
