...
inline std::uint8_t ToUnderlying(SymbolFlags flags) { return std::uint8_t(flags); }

inline SymbolFlags operator|(SymbolFlags left, SymbolFlags right) noexcept
{
...
inline SymbolFlags operator~(SymbolFlags flags) noexcept
{
