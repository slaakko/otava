...
TrivialDestructor::TrivialDestructor(Module* module_, SymbolId id_) : FunctionSymbol(module_, id_), type(), typeId(zeroSymbolId)
{
}

TrivialDestructor::TrivialDestructor(Module* module_, SymbolId id_, TypeSymbol* type_, Context* context) :
    FunctionSymbol(module_, id_, "@destructor"), type(type_), typeId(zeroSymbolId)
{
