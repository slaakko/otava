...
public:
    InstantiationRequest(FunctionSymbol* function_, 
        const std::map<TemplateParameterSymbol*, TypeSymbol*, TemplateParamLess>& templateParameterMap_);
    inline FunctionSymbol* Function() const noexcept { return function; }
    inline const std::map<TemplateParameterSymbol*, TypeSymbol*, TemplateParamLess>& 
