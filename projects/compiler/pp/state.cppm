...
using OtavaLexer = soul::lexer::Lexer<otava::lexer::OtavaLexer<char32_t>, char32_t>;
...
{
public:
    State* GetState(OtavaLexer* lexer);
    static LexerStateMap& Instance();
private:
    std::mutex mtx;
    std::map<OtavaLexer*, State*> stateMap;
