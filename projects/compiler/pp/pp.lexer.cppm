// this file has been automatically generated from 'D:/work/otava/projects/compiler/pp/pp.lexer' using soul lexer generator oslg version 0.2.5
...
{
    std::lock_guard<std::mutex> lock(otava::pp::lexer::MakeLexerMtx()); 
    auto lxr = soul::lexer::Lexer<PPLexer<Char>, Char>(start, end, fileName);
    lxr.SetClassMap(otava::pp::lexer::GetClassMap<Char>());
    lxr.SetTokenCollection(otava::pp::lexer::GetTokens());
    lxr.SetKeywordMap(otava::pp::lexer::GetKeywords<Char>());
    return lxr;
}
...
soul::lexer::Lexer<PPLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName)
{
    std::lock_guard<std::mutex> lock(otava::pp::lexer::MakeLexerMtx());
    auto lxr = soul::lexer::Lexer<PPLexer<Char>, Char>(start, end, fileName);
    lxr.SetClassMap(otava::pp::lexer::GetClassMap<Char>(moduleFileName, resourceFlags));
    lxr.SetTokenCollection(otava::pp::lexer::GetTokens());
    lxr.SetKeywordMap(otava::pp::lexer::GetKeywords<Char>());
    return lxr;
}
