// this file has been automatically generated from 'D:/src/otava-0.2.3/projects/compiler/intermediate/intermediate.lexer' using soul lexer generator oslg version 0.2.5
...
{
    std::lock_guard<std::mutex> lock(otava::intermediate::lexer::MakeLexerMtx()); 
    auto lxr = soul::lexer::Lexer<IntermediateLexer<Char>, Char>(start, end, fileName);
    lxr.SetClassMap(otava::intermediate::lexer::GetClassMap<Char>());
    lxr.SetTokenCollection(otava::intermediate::lexer::GetTokens());
    lxr.SetKeywordMap(otava::intermediate::lexer::GetKeywords<Char>());
    return lxr;
}
...
soul::lexer::Lexer<IntermediateLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName)
{
    std::lock_guard<std::mutex> lock(otava::intermediate::lexer::MakeLexerMtx());
    auto lxr = soul::lexer::Lexer<IntermediateLexer<Char>, Char>(start, end, fileName);
    lxr.SetClassMap(otava::intermediate::lexer::GetClassMap<Char>(moduleFileName, resourceFlags));
    lxr.SetTokenCollection(otava::intermediate::lexer::GetTokens());
    lxr.SetKeywordMap(otava::intermediate::lexer::GetKeywords<Char>());
    return lxr;
}
