...
// this file has been automatically generated from 'D:/work/otava/projects/compiler/parser/concept.parser' using soul parser generator ospg version 0.1.0
...
soul::parser::Match ConceptParser<LexerT>::ConceptDefinition(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            otava::ast::ConceptDefinitionNode *conceptDefinitionNode = new otava::ast::ConceptDefinitionNode(span, lexer.File(), conceptName.release(), assign.release(), constraintExpr.release(), semicolon.release());
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::RequiresClauseNode(span, lexer.File(), orExpr.release()));
            }
        }
        *parentMatch0 = match;
    }
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch10 = &match;
                                            {
                                                ...
                                                if (match.hit)
                                                {
                                                    node.reset(new otava::ast::BinaryExprNode(span, lexer.File(), new otava::ast::DisjunctionNode(opSpan, lexer.File()), node.release(), right.release()));
                                                }
                                                *parentMatch10 = match;
                                            }
                                            *parentMatch9 = match;
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch10 = &match;
                                            {
                                                ...
                                                if (match.hit)
                                                {
                                                    node.reset(new otava::ast::BinaryExprNode(span, lexer.File(), new otava::ast::ConjunctionNode(opSpan, lexer.File()), node.release(), right.release()));
                                                }
                                                *parentMatch10 = match;
                                            }
                                            *parentMatch9 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::RequiresExprNode(span, lexer.File(), params.release(), body.release()));
            }
        }
        *parentMatch0 = match;
    }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            node.reset(new otava::ast::ParameterListNode(lexer.GetSpan(pos), lexer.File()));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            node.reset(new otava::ast::RequirementBodyNode(lexer.GetSpan(pos), lexer.File()));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
                ...
                {
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::SimpleRequirementNode(span, lexer.File(), expr.release(), semicolon.release()));
                    }
                }
                *parentMatch3 = match;
            }
                ...
                {
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::TypeRequirementNode(span, lexer.File(), nns.release(), typeName.release(), semicolon.release()));
                    }
                }
                *parentMatch12 = match;
            }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::CompoundRequirementNode(lexer.GetSpan(pos), lexer.File(), expr.release(), noexcept_.release(), returnTypeRequirement.release(), semicolon.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::ReturnTypeRequirementNode(span, lexer.File(), typeConstraint.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::NestedRequirementNode(span, lexer.File(), constraintExpr.release(), semicolon.release()));
            }
        }
        *parentMatch0 = match;
    }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soul::parser::Match* parentMatch9 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch10 = &match;
                                        {
                                            ...
                                            if (match.hit)
                                            {
                                                conceptName.reset(new otava::ast::QualifiedIdNode(span, lexer.File(), nns.release(), conceptName1.release()));
                                            }
                                            *parentMatch10 = match;
                                        }
                                        *parentMatch9 = match;
                        ...
                        if (match.hit)
                        {
                            node.reset(new otava::ast::TypeConstraintNode(span, lexer.File(), conceptName.release()));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
