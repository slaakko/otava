...
// this file has been automatically generated from 'D:/work/otava/projects/compiler/parser/lambda.parser' using soul parser generator ospg version 0.1.0
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::LambdaIntroducerNode(span, lexer.File(), capture.release()));
            }
        }
        *parentMatch0 = match;
    }
                                    ...
                                    {
                                        {
                                            ...
                                            #endif
                                            return soul::parser::Match(true, new otava::ast::CurrentObjectCopyCapture(span, lexer.File()));
                                        }
                                    }
                                    *parentMatch7 = match;
                                }
                        ...
                        soul::parser::Match* parentMatch8 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                span = lexer.GetSpan(pos);
                                {
                                    ...
                                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "SimpleCapture");
                                    #endif
                                    return soul::parser::Match(true, new otava::ast::CurrentObjectByRefCapture(span, lexer.File()));
                                }
                            }
                            *parentMatch8 = match;
                        }
