...
// this file has been automatically generated from 'D:/work/otava/projects/compiler/parser/enum.parser' using soul parser generator ospg version 0.1.0
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::EnumHeadNode(span, lexer.File(), enumKey.release(), name.release(), enumBase.release(), attributes.release()));
            }
        }
        *parentMatch0 = match;
    }
                ...
                soul::parser::Match* parentMatch12 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        span = lexer.GetSpan(pos);
                        {
                            ...
                            if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "EnumKey");
                            #endif
                            return soul::parser::Match(true, new otava::ast::EnumNode(span, lexer.File()));
                        }
                    }
                    *parentMatch12 = match;
                }
                    ...
                    {
                        {
                            ...
                            #endif
                            return soul::parser::Match(true, new otava::ast::QualifiedIdNode(lexer.GetSpan(pos), lexer.File(), nns.release(), identifier.release()));
                        }
                    }
                    *parentMatch3 = match;
                }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::EnumBaseNode(span, lexer.File(), typeSpecifiers.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::EnumeratorNode(span, lexer.File(), identifier.release(), attributes.release()));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match EnumParser<LexerT>::OpaqueEnumDeclaration(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            otava::ast::Node *node = new otava::ast::OpaqueEnumDeclarationNode(span, lexer.File(), enumKey.release(), enumHeadName.release(), enumBase.release(), attributes.release(), semicolon.release());
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch8 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    otava::ast::Node *node = new otava::ast::ElaboratedEnumSpecifierNode(span, lexer.File(), new otava::ast::QualifiedIdNode(nnsSpan, lexer.File(), nns.release(), identifier.release()));
                                    otava::symbols::ProcessEnumForwardDeclaration(node, context);
                                    {
                                        #ifdef SOUL_PARSER_DEBUG_SUPPORT
                    ...
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            soul::parser::Match* parentMatch10 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    otava::ast::Node *node = new otava::ast::ElaboratedEnumSpecifierNode(span, lexer.File(), identifier2.release());
                                    otava::symbols::ProcessEnumForwardDeclaration(node, context);
                                    {
                                        #ifdef SOUL_PARSER_DEBUG_SUPPORT
                                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "ElaboratedEnumSpecifier");
