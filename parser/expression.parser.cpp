...
// this file has been automatically generated from 'D:/work/otava/parser/expression.parser' using soul parser generator spg version 5.2.0
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            soul::parser::Match* parentMatch8 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    otava::ast::Node *r = right.release();
                                    span.Union(r->GetSpan());
                                    expr.reset(new otava::ast::BinaryExprNode(span, lexer.File(), op.release(), leftExpr.release(), r));
                                }
                                *parentMatch8 = match;
                            }
                            *parentMatch7 = match;
                                ...
                                soul::parser::Match* parentMatch12 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch13 = &match;
                                    {
                                        ...
                                        if (match.hit)
                                        {
                                            ...
                                            expr.reset(new otava::ast::ConditionalExprNode(span, lexer.File(), expr.release(), quest.release(), thenExpr.release(), colon.release(), e));
                                        }
                                        *parentMatch13 = match;
                                    }
                                    *parentMatch12 = match;
                        ...
                        {
                            {
                                ...
                                #endif
                                return soul::parser::Match(true, new otava::ast::YieldExprNode(span, lexer.File(), assignmentExpr.release()));
                            }
                        }
                        *parentMatch5 = match;
                    }
                                ...
                                {
                                    {
                                        ...
                                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "YieldExpression");
                                        #endif
                                        return soul::parser::Match(true, new otava::ast::YieldExprNode(span, lexer.File(), bracedInitList.release()));
                                    }
                                }
                                *parentMatch7 = match;
                            }
                ...
                {
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::DotStarNode(lexer.GetSpan(pos), lexer.File()));
                    }
                }
                *parentMatch1 = match;
            }
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            expr.reset(new otava::ast::CastExprNode(span, lexer.File(), typeId.release(), c, lpSpan, rpSpan));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
                            ...
                            if (match.hit)
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        if (match.hit)
                                        {
                                            expr.reset(new otava::ast::UnaryExprNode(span, lexer.File(), op.release(), child.release()));
                                        }
                                        *parentMatch8 = match;
                                    }
                                    *parentMatch7 = match;
                ...
                {
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::DerefNode(lexer.GetSpan(pos), lexer.File()));
                    }
                }
                *parentMatch1 = match;
            }
                ...
                {
                    {
                        ...
                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "UnaryOp");
                        #endif
                        return soul::parser::Match(true, new otava::ast::AddrOfNode(lexer.GetSpan(pos), lexer.File()));
                    }
                }
                *parentMatch2 = match;
            }
            ...
            soul::parser::Match* parentMatch3 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    span.Union(c->GetSpan());
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::AwaitExprNode(span, lexer.File(), c));
                    }
                }
                *parentMatch3 = match;
            }
                    ...
                    soul::parser::Match* parentMatch10 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            rpSpan = lexer.GetSpan(pos);
                            {
                                ...
                                #endif
                                return soul::parser::Match(true, new otava::ast::SizeOfTypeExprNode(span, lexer.File(), typeId.release(), lpSpan, rpSpan));
                            }
                        }
                        *parentMatch10 = match;
                    }
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch21 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch22 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        childNode.reset(otava::parser::token::ParseIdentifier(lexer.GetSpan(pos), lexer.File(), lexer.FileName(), lexer.GetToken(pos)));
                                    }
                                    *parentMatch22 = match;
                                }
                                *parentMatch21 = match;
                            ...
                            soul::parser::Match* parentMatch24 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    span.Union(rpSpan);
                                    {
                                        ...
                                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "SizeOfExpression");
                                        #endif
                                        return soul::parser::Match(true, new otava::ast::SizeOfPackExprNode(span, lexer.File(), childNode.release(), ellipsisPos, lpSpan, rpSpan));
                                    }
                                }
                                *parentMatch24 = match;
                            }
                        ...
                        soul::parser::Match* parentMatch29 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                span.Union(c->GetSpan());
                                {
                                    ...
                                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "SizeOfExpression");
                                    #endif
                                    return soul::parser::Match(true, new otava::ast::SizeOfUnaryExprNode(span, lexer.File(), c));
                                }
                            }
                            *parentMatch29 = match;
                        }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            span.Union(rpSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AlignOfExprNode(span, lexer.File(), typeId.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            span.Union(rpSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::NoexceptExprNode(span, lexer.File(), expr.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
                                ...
                                case otava::token::COLON_COLON:
                                {
                                    ...
                                    soul::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch8 = &match;
                                        {
                                            ...
                                            {
                                                span = lexer.GetSpan(pos);
                                                colonColonNode.reset(new otava::ast::ColonColonNode(span, lexer.File()));
                                            }
                                            *parentMatch8 = match;
                                        }
                                        *parentMatch7 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::NewExprNode(span, lexer.File(), placement.release(), newTypeId.release(), newInitializer.release(), colonColonNode.release(), newPos));
            }
        }
        *parentMatch0 = match;
    }
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            placement.reset(new otava::ast::NewPlacementNode(span, lexer.File()));
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch5 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    {
                                        lpSpan = lexer.GetSpan(pos);
                                        node.reset(new otava::ast::NewInitializerNode(lpSpan, lexer.File()));
                                    }
                                    *parentMatch6 = match;
                                }
                                *parentMatch5 = match;
            ...
            {
                {
                    ...
                    #endif
                    return soul::parser::Match(true, new otava::ast::ParenNewTypeIdNode(span, lexer.File(), typeId.release(), lpSpan, rpSpan));
                }
            }
            *parentMatch1 = match;
        }
                                    ...
                                    {
                                        {
                                            ...
                                            if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "NewTypeId");
                                            #endif
                                            return soul::parser::Match(true, new otava::ast::NewTypeIdNode(span, lexer.File(), typeSpecifierSeq.release(), newDeclarator.release()));
                                        }
                                    }
                                    *parentMatch18 = match;
                                }
                                            ...
                                            {
                                                {
                                                    ...
                                                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "NewTypeId");
                                                    #endif
                                                    return soul::parser::Match(true, new otava::ast::NewTypeIdNode(span, lexer.File(), typeSpecifierSeq.release(), nullptr));
                                                }
                                            }
                                            *parentMatch20 = match;
                                        }
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                node.reset(new otava::ast::NewDeclaratorNode(lexer.GetSpan(pos), lexer.File()));
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        node.reset(new otava::ast::ArrayNewDeclaratorNode(lexer.GetSpan(pos), lexer.File()));
                                ...
                                {
                                    {
                                        ...
                                        #endif
                                        return soul::parser::Match(true, new otava::ast::ArrayDeletePtrNode(span, lexer.File(), ptr1.release(), colonColonNode.release(), deletePos, lbSpan, rbSpan));
                                    }
                                }
                                *parentMatch17 = match;
                            }
                                ...
                                {
                                    {
                                        ...
                                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "DeleteExpression");
                                        #endif
                                        return soul::parser::Match(true, new otava::ast::DeletePtrNode(span, lexer.File(), ptr2.release(), colonColonNode.release(), deletePos));
                                    }
                                }
                                *parentMatch19 = match;
                            }
                                                            ...
                                                            if (match.hit)
                                                            {
                                                                ...
                                                                soul::parser::Match* parentMatch18 = &match;
                                                                {
                                                                    ...
                                                                    soul::parser::Match* parentMatch19 = &match;
                                                                    {
                                                                        ...
                                                                        {
                                                                            lpSpan = lexer.GetSpan(pos);
                                                                            invokeNode.reset(new otava::ast::InvokeExprNode(span, lexer.File(), simpleTypeSpecifier1.release()));
                                                                        }
                                                                        *parentMatch19 = match;
                                                                    }
                                                                    *parentMatch18 = match;
                                            ...
                                            lexer.SetPos(save);
                                            {
                                                ...
                                                soul::parser::Match* parentMatch25 = &match;
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch26 = &match;
                                                    {
                                                        ...
                                                        {
                                                            span = lexer.GetSpan(pos);
                                                            expr.reset(new otava::ast::InvokeExprNode(span, lexer.File(), simpleTypeSpecifier1.release()));
                                                        }
                                                        *parentMatch26 = match;
                                                    }
                                                    *parentMatch25 = match;
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch34 = &match;
                                                        {
                                                            ...
                                                            soul::parser::Match* parentMatch35 = &match;
                                                            {
                                                                ...
                                                                {
                                                                    lpSpan = lexer.GetSpan(pos);
                                                                    invokeNode.reset(new otava::ast::InvokeExprNode(span, lexer.File(), typenameSpecifier1.release()));
                                                                }
                                                                *parentMatch35 = match;
                                                            }
                                                            *parentMatch34 = match;
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        ...
                                        soul::parser::Match* parentMatch41 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch42 = &match;
                                            {
                                                ...
                                                {
                                                    span = lexer.GetSpan(pos);
                                                    expr.reset(new otava::ast::InvokeExprNode(span, lexer.File(), simpleTypeSpecifier2.release()));
                                                }
                                                *parentMatch42 = match;
                                            }
                                            *parentMatch41 = match;
                                        ...
                                        switch (*lexer)
                                        {
                                                ...
                                                if (match.hit)
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch60 = &match;
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch61 = &match;
                                                        {
                                                            ...
                                                            {
                                                                rbSpan = lexer.GetSpan(pos);
                                                                expr.reset(new otava::ast::SubscriptExprNode(span, lexer.File(), expr.release(), index.release(), lbSpan, rbSpan));
                                                            }
                                                            *parentMatch61 = match;
                                                        }
                                                        *parentMatch60 = match;
                                                ...
                                                if (match.hit)
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch70 = &match;
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch71 = &match;
                                                        {
                                                            ...
                                                            if (match.hit)
                                                            {
                                                                otava::ast::Node *ie = idExpr1.release();
                                                                span.Union(ie->GetSpan());
                                                                expr.reset(new otava::ast::MemberExprNode(span, lexer.File(), expr.release(), dotOp.release(), ie));
                                                            }
                                                            *parentMatch71 = match;
                                                        }
                                                        *parentMatch70 = match;
                                                ...
                                                if (match.hit)
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch73 = &match;
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch74 = &match;
                                                        {
                                                            ...
                                                            if (match.hit)
                                                            {
                                                                otava::ast::Node *ie = idExpr2.release();
                                                                span.Union(ie->GetSpan());
                                                                expr.reset(new otava::ast::MemberExprNode(span, lexer.File(), expr.release(), arrowOp.release(), ie));
                                                            }
                                                            *parentMatch74 = match;
                                                        }
                                                        *parentMatch73 = match;
                                            ...
                                            case otava::token::PLUS_PLUS:
                                            {
                                                ...
                                                soul::parser::Match* parentMatch75 = &match;
                                                {
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        expr.reset(new otava::ast::PostfixIncExprNode(span, lexer.File(), expr.release(), lexer.GetSpan(pos)));
                                                    }
                                                    *parentMatch75 = match;
                                                }
                                                if (match.hit)
                                            ...
                                            case otava::token::MINUS_MINUS:
                                            {
                                                ...
                                                soul::parser::Match* parentMatch76 = &match;
                                                {
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        expr.reset(new otava::ast::PostfixDecExprNode(span, lexer.File(), expr.release(), lexer.GetSpan(pos)));
                                                    }
                                                    *parentMatch76 = match;
                                                }
                                                if (match.hit)
                                        ...
                                        switch (*lexer)
                                        {
                                            case otava::token::DYNAMIC_CAST:
                                            {
                                                ...
                                                soul::parser::Match* parentMatch10 = &match;
                                                {
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        op.reset(new otava::ast::DynamicCastNode(lexer.GetSpan(pos), lexer.File()));
                                                    }
                                                    *parentMatch10 = match;
                                                }
                                                if (match.hit)
                                            ...
                                            case otava::token::STATIC_CAST:
                                            {
                                                ...
                                                soul::parser::Match* parentMatch11 = &match;
                                                {
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        op.reset(new otava::ast::StaticCastNode(lexer.GetSpan(pos), lexer.File()));
                                                    }
                                                    *parentMatch11 = match;
                                                }
                                                if (match.hit)
                                            ...
                                            case otava::token::REINTERPRET_CAST:
                                            {
                                                ...
                                                soul::parser::Match* parentMatch12 = &match;
                                                {
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        op.reset(new otava::ast::ReinterpretCastNode(lexer.GetSpan(pos), lexer.File()));
                                                    }
                                                    *parentMatch12 = match;
                                                }
                                                if (match.hit)
                                            ...
                                            case otava::token::CONST_CAST:
                                            {
                                                ...
                                                soul::parser::Match* parentMatch13 = &match;
                                                {
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        op.reset(new otava::ast::ConstCastNode(lexer.GetSpan(pos), lexer.File()));
                                                    }
                                                    *parentMatch13 = match;
                                                }
                                                if (match.hit)
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::CppCastExprNode(lexer.GetSpan(pos), lexer.File(), typeId.release(), child.release(), op.release(), laSpan, raSpan, lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::TypeIdExprNode(span, lexer.File(), child.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
                            ...
                            soul::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch9 = &match;
                                    {
                                        ...
                                        {
                                            lpSpan = lexer.GetSpan(pos);
                                            invokeNode.reset(new otava::ast::InvokeExprNode(lexer.GetSpan(pos), lexer.File(), exprNode.release()));
                                        }
                                        *parentMatch9 = match;
                                    }
                                    *parentMatch8 = match;
                                ...
                                {
                                    {
                                        ...
                                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "PrimaryExpression");
                                        #endif
                                        return soul::parser::Match(true, new otava::ast::ThisNode(lexer.GetSpan(pos), lexer.File()));
                                    }
                                }
                                *parentMatch6 = match;
                            }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        {
                            lpSpan = lexer.GetSpan(pos);
                            expr.reset(new otava::ast::FoldExprNode(lpSpan, lexer.File()));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::ParenthesizedExprNode(span, lexer.File(), expr.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    {
                        span = lexer.GetSpan(pos);
                        dotNode.reset(new otava::ast::DotNode(span, lexer.File()));
                    }
                    *parentMatch3 = match;
                }
                *parentMatch2 = match;
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            templateNode.reset(new otava::ast::TemplateNode(lexer.GetSpan(pos), lexer.File()));
                            {
                                ...
                                #endif
                                return soul::parser::Match(true, new otava::ast::PairNode(span, lexer.File(), dotNode.release(), templateNode.release()));
                            }
                        }
                        *parentMatch5 = match;
                    }
                        ...
                        {
                            {
                                ...
                                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "DotOp");
                                #endif
                                return soul::parser::Match(true, new otava::ast::DotNode(lexer.GetSpan(pos), lexer.File()));
                            }
                        }
                        *parentMatch7 = match;
                    }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    span = lexer.GetSpan(pos);
                    arrowNode.reset(new otava::ast::ArrowNode(span, lexer.File()));
                }
                *parentMatch2 = match;
            }
            *parentMatch1 = match;
                ...
                soul::parser::Match* parentMatch4 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        templateNode.reset(new otava::ast::TemplateNode(lexer.GetSpan(pos), lexer.File()));
                        {
                            ...
                            #endif
                            return soul::parser::Match(true, new otava::ast::PairNode(span, lexer.File(), arrowNode.release(), templateNode.release()));
                        }
                    }
                    *parentMatch4 = match;
                }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::ThrowExprNode(span, lexer.File(), expr.release()));
            }
        }
        *parentMatch0 = match;
    }
