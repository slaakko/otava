...
// this file has been automatically generated from 'D:/work/otava/parser/attribute.parser' using soul parser generator spg version 5.2.0
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        node.reset(new otava::ast::AttributeSpecifierSequenceNode(lexer.GetSpan(pos), lexer.File()));
                                    ...
                                    soul::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            if (match.hit)
                                            {
                                                ...
                                                span = lbSpan2;
                                                attributeSpecifierNode.reset(new otava::ast::AttributeSpecifierNode(span, lexer.File()));
                                            }
                                            *parentMatch9 = match;
                                        }
                                        *parentMatch8 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeUsingPrefixNode(span, lexer.File(), ns.release(), colonSpan));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeNode(span, lexer.File(), attributeToken.release(), attributeArgs.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeScopedTokenNode(span, lexer.File(), ns.release(), colonColon.release(), identifier.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeArgumentsNode(span, lexer.File(), balancedTokenSeq.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        sequence.reset(new otava::ast::BalancedTokenSequenceNode(lexer.GetSpan(pos), lexer.File()));
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch5 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        seq.reset(new otava::ast::BalancedTokenSequenceNode(lexer.GetSpan(pos), lexer.File()));
                ...
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soul::parser::Match* parentMatch26 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                seq.reset(new otava::ast::TokenNode(lexer.GetSpan(pos), lexer.File(), util::ToUtf8(lexer.GetToken(pos).ToString())));
                            }
                            *parentMatch26 = match;
                        }
                        *parentMatch25 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AlignmentSpecifierNode(span, lexer.File(), alignment.release(), ellipsis.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
