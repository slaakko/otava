...
std::map<std::int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<std::int64_t, std::string> ruleNameMap = {
        ...
        { 8966079074640330784, "DeclarationParser.AssumeDefiningTypeId" },
        { 8966079074640330785, "DeclarationParser.DeclSpecifierSeq" },
        { 8966079074640330786, "DeclarationParser.Inline" },
        { 8966079074640330787, "DeclarationParser.DeclSpecifier" },
        { 8966079074640330788, "DeclarationParser.StorageClassSpecifier" },
        { 8966079074640330789, "DeclarationParser.FunctionSpecifier" },
        { 8966079074640330790, "DeclarationParser.ExplicitSpecifier" },
        { 8966079074640330791, "DeclarationParser.InitDeclaratorList" },
        { 8966079074640330792, "DeclarationParser.InitDeclarator" },
        { 8966079074640330793, "DeclarationParser.DeclaratorPushClassScope" },
        { 8966079074640330794, "DeclarationParser.Declarator" },
        { 8966079074640330795, "DeclarationParser.PtrDeclarator" },
        { 8966079074640330796, "DeclarationParser.NoPtrDeclarator" },
        { 8966079074640330797, "DeclarationParser.ParametersAndQualifiers" },
        { 8966079074640330798, "DeclarationParser.TrailingReturnType" },
        { 8966079074640330799, "DeclarationParser.PtrOperator" },
        { 8966079074640330800, "DeclarationParser.AbstractDeclarator" },
        { 8966079074640330801, "DeclarationParser.NoPtrAbstractDeclarator" },
        { 8966079074640330802, "DeclarationParser.PtrAbstractDeclarator" },
        { 8966079074640330803, "DeclarationParser.AbstractPackDeclarator" },
        { 8966079074640330804, "DeclarationParser.NoPtrAbstractPackDeclarator" },
        { 8966079074640330805, "DeclarationParser.DeclaratorId" },
        { 8966079074640330806, "DeclarationParser.Ptr" },
        { 8966079074640330807, "DeclarationParser.LvalueRef" },
        { 8966079074640330808, "DeclarationParser.RvalueRef" },
        { 8966079074640330809, "DeclarationParser.RefQualifier" },
        { 8966079074640330810, "DeclarationParser.CVQualifierSeq" },
        { 8966079074640330811, "DeclarationParser.CVQualifier" },
        { 8966079074640330812, "DeclarationParser.NoexceptSpecifier" },
        { 8966079074640330813, "DeclarationParser.ThrowSpecifier" },
        { 8966079074640330814, "DeclarationParser.AttributeDeclaration" },
        ...
        { 7723722954927767553, "TranslationUnitParser.TranslationUnit" },
        { 7723722954927767554, "TranslationUnitParser.ModuleUnit" },
