...
public:
    ...
    FunctionSymbol* GetFunctionByIndex(std::int32_t functionIndex, Context* context) const;
    ...
    void TryInitVTab(std::vector<FunctionSymbol*>& vtab, Context* context, const soul::ast::FullSpan& fullSpan, bool clear);
